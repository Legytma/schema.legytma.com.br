...
```txt
https://schema.legytma.com.br/1.1.2/schema/edge_insets_object.schema.json#/oneOf/1
```
...
```json
{"$ref":"https://schema.legytma.com.br/1.1.2/schema/edge_insets_object.schema.json#/definitions/type"}
```
