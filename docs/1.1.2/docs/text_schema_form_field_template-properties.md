# Untitled undefined type in Text Schema Form Field Template Schema

```txt
https://schema.legytma.com.br/1.1.2/schema/widget/text_schema_form_field_template.schema.json#/properties
```
