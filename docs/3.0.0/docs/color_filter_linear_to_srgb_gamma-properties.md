# Untitled undefined type in Color Filter Linear To Srgb Gamma Schema

```txt
https://schema.legytma.com.br/3.0.0/schema/color_filter_linear_to_srgb_gamma.schema.json#/properties
```
