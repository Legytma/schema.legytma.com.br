...
```txt
https://schema.legytma.com.br/3.0.0/schema/bottom_app_bar_theme.schema.json
```
...
| [shape](#shape)         | Multiple | Optional | can be null    | [Bottom App Bar Theme](bottom_app_bar_theme-properties-dynamic.md) |
