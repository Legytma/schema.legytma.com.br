# Untitled undefined type in Edge Insets From Window Padding Schema

```txt
https://schema.legytma.com.br/3.0.0/schema/edge_insets_fromWindowPadding.schema.json#/properties
```
