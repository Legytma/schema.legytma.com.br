...
```txt
https://schema.legytma.com.br/3.0.0/schema/popup_menu_theme_data.schema.json
```
...
| [shape](#shape)         | Multiple | Optional | can be null    | [Popup Menu Theme Data](bottom_app_bar_theme-properties-dynamic.md)        |
