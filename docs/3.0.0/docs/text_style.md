...
```txt
https://schema.legytma.com.br/3.0.0/schema/text_style.schema.json
```
...
| [background](#background)                   | Multiple  | Optional | can be null    | [Text Style](bottom_app_bar_theme-properties-dynamic.md)                        |
...
| [foreground](#foreground)                   | Multiple  | Optional | can be null    | [Text Style](bottom_app_bar_theme-properties-dynamic.md)                        |
