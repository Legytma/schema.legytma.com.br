...
```txt
https://schema.legytma.com.br/3.0.0/schema/card_theme.schema.json
```
...
| :---------------------------- | -------- | -------- | -------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [shape](#shape)               | Multiple | Optional | can be null    | [Card Theme](bottom_app_bar_theme-properties-dynamic.md)                             |
...
| [margin](#margin)             | Multiple | Optional | cannot be null | [Card Theme](button_bar_theme_data-properties-edge-insets-geometry.md) |
