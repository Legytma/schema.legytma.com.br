# Untitled undefined type in Floating Action Button Animator Schema

```txt
https://schema.legytma.com.br/3.0.0/schema/floating_action_button_animator.schema.json#/properties
```
