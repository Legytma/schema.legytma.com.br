...
```txt
https://schema.legytma.com.br/2.0.0/schema/border_side.schema.json#/properties/top
```
...
```json
{"$ref":"https://schema.legytma.com.br/2.0.0/schema/border_side.schema.json#/definitions/type"}
```
