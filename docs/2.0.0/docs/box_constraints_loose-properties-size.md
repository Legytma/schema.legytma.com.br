...
```txt
https://schema.legytma.com.br/2.0.0/schema/size.schema.json#/properties/size
```
...
```json
{"$ref":"https://schema.legytma.com.br/2.0.0/schema/size.schema.json#/definitions/type"}
```
