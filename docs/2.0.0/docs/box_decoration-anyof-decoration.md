...
```txt
https://schema.legytma.com.br/2.0.0/schema/decoration.schema.json#/anyOf/0
```
...
```json
{"$ref":"https://schema.legytma.com.br/2.0.0/schema/decoration.schema.json#/definitions/type"}
```
