# Untitled undefined type in Color Filter Srgb To Linear Gamma Schema

```txt
https://legytma.com.br/schema/color_filter_srgb_to_linear_gamma.schema.json#/properties
```
